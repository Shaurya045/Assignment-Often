    ...
    >
      ...
      {isImage &&
        ...
        particles.map((particle) => {
          ...
          const floatY =
            Math.sin(particleFrame * particle.frequency) * particle.amplitude;
          const floatX =
            Math.cos(particleFrame * particle.frequency * 0.7) *
        ...
        {frame > titleStart && (
          <div
            style={{
              ...
              transform: `scale(${titleScale}) translateY(${interpolate(
                titleProgress,
                [0, 1],
                [30, 0]
              )}px)`,
          ...
          >
            <h1
              style={{
                ...
                fontWeight: "800",
                background:
                  "linear-gradient(135deg, #fff 0%, #f0f8ff 50%, #e6f3ff 100%)",
          ...
          <div
            style={{
              ...
              transform: `translateY(${interpolate(
                ...
                [0, 1],
                [30, 0]
              )}px) scale(${interpolate(statusProgress, [0, 1], [0.9, 1])})`,
              display: "flex",
              gap: "30px",
              flexWrap: "wrap",
              justifyContent: "center",
